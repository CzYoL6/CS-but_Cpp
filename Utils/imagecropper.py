...
def image_crop(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".png"):
            ...
            if image is not None:
                ...
                cropped = image[700:1001, 700:1221]
                cropped = image[1400:2001, 1400:2441]
...
if __name__ == "__main__":
    ...
    input_folder = "E:\\AdobeWorks\\Valorant\\png\\3kill"
    output_folder = "E:\\AdobeWorks\\Valorant\\cropped\\3kill"

    image_crop(input_folder, output_folder)