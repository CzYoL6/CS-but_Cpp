...
// debug menu of your game/gui! Removing this file from your project is hindering access to documentation for everyone
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear imgui context. Refer to examples gui!");
    ...
    if (show_app_dockspace)           ShowExampleAppDockSpace(&show_app_dockspace);     // Process the Docking gui first, as explicit DockSpace() nodes needs to be submitted early (read comments near the DockSpace function)
    if (show_app_documents)           ShowExampleAppDocuments(&show_app_documents);     // Process the Document gui next, as it may also use a DockSpace()
    ...
    if (ImGui::TreeNode("Tabs"))
    {
        ...
        if (ImGui::TreeNode("TabItemButton & Leading/Trailing flags"))
        {
            ...
            if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
            {
                ...
                // Demo Trailing Tabs: click the "+" button to add a new tab (in your gui you may want to use a font icon instead of the "+")
...
void ShowExampleAppDockSpace(bool* p_open)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        HelpMarker(
            ...
            "This demo gui has nothing to do with enabling docking!" "\n\n"
            "This demo gui only demonstrate the use of ImGui::DockSpace() which allows you to manually create a docking node _within_ another window." "\n\n"
